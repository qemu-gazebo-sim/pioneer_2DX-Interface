...
RobotParams_t p2pb_params = {
    ...
    1,
    {
        {115, 130, 90},    {155, 115, 50},    {190, 80, 30},   {210, 25, 10},   {210, -25, -10},   {190, -80, -30},
        {155, -115, -50},  {115, -130, -90},  {50, 130, 90},   {90, 115, 50},   {125, 80, 30},     {145, 25, 10},
        {145, -25, -10},   {125, -80, -30},   {90, -115, -50}, {50, -130, -90}, {-115, -130, -90}, {-155, -115, -130},
        {-190, -80, -150}, {-210, -25, -170}, {-210, 25, 170}, {-190, 80, 150}, {-155, 115, 130},  {-115, 130, 90},
    }
};
...
RobotParams_t peoplebot_sh_params = {
    ...
    1,
    {
        {115, 130, 90},     {155, 115, 50},    {190, 80, 30},     {210, 25, 10},     {210, -25, -10},
        {190, -80, -30},    {155, -115, -50},  {115, -130, -90},  {-115, -130, -90}, {-155, -115, -130},
        {-190, -80, -150},  {-210, -25, -170}, {-210, 25, 170},   {-190, 80, 150},   {-155, 115, 130},
        {-115, 130, 90},    {50, 130, 90},     {90, 115, 50},     {125, 80, 30},     {145, 25, 10},
        {145, -25, -10},    {125, -80, -30},   {90, -115, -50},   {50, -130, -90},   {-195, -130, -90},
        {-235, -115, -130}, {-270, -80, -150}, {-290, -25, -170}, {-290, 25, 170},   {-270, 80, 150},
        {-235, 115, 130},   {-195, 130, 90},
    }
};
...
RobotParams_t perfpbplus_params = {
    ...
    {
        {115, 130, 90},     {155, 115, 50},    {190, 80, 30},      {210, 25, 10},     {210, -25, -10},
        {190, -80, -30},    {155, -115, -50},  {115, -130, -90},   {50, 130, 90},     {90, 115, 50},
        {125, 80, 30},      {145, 25, 10},     {145, -25, -10},    {125, -80, -30},   {90, -115, -50},
        {50, -130, -90},    {-115, -130, -90}, {-155, -115, -130}, {-190, -80, -150}, {-210, -25, -170},
        {-210, 25, 170},    {-190, 80, 150},   {-155, 115, 130},   {-115, 130, 90},   {-195, -130, -90},
        {-235, -115, -130}, {-270, -80, -150}, {-290, -25, -170},  {-290, 25, 170},   {-270, 80, 150},
        {-235, 115, 130},   {-195, 130, 90},
    }
};
...
RobotParams_t powerbot_sh_params = {
    ...
    1,
    {
        {152, 278, 90},     {200, 267, 65},    {241, 238, 45},     {274, 200, 35},     {300, 153, 25},
        {320, 96, 15},      {332, 33, 5},      {0, 0, -180},       {332, -33, -5},     {320, -96, -15},
        {300, -153, -25},   {274, -200, -35},  {241, -238, -45},   {200, -267, -65},   {152, -278, -90},
        {0, 0, -180},       {-298, -278, -90}, {-347, -267, -115}, {-388, -238, -135}, {-420, -200, -145},
        {-447, -153, -155}, {-467, -96, -165}, {-478, -33, -175},  {0, 0, -180},       {-478, 33, 175},
        {-467, 96, 165},    {-447, 153, 155},  {-420, 200, 145},   {-388, 238, 135},   {-347, 267, 115},
        {-298, 278, 90},    {0, 0, -180},
    }
};
